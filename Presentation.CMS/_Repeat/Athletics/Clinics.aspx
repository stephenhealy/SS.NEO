<%@ Page Title="" Language="C#" MasterPageFile="~/_Masters/repeat.master" AutoEventWireup="true" CodeBehind="Clinics.aspx.cs" Inherits="Presentation.CMS._Repeat.Content.Clinics" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Edit" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <asp:TextBox ID="txtStart" runat="server" CssClass="form-control date" MaxLength="10" Width="150" />
            <asp:RequiredFieldValidator ControlToValidate="txtStart" CssClass="validation-required validation-text" ValidationGroup="valSave" runat="server" ErrorMessage="" Text="" Display="Dynamic" SetFocusOnError="true" ID="RequiredFieldValidator4" /> 
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">End Date: *</label>
        <div class="col-sm-10">
            <asp:TextBox ID="txtEnd" runat="server" CssClass="form-control date" MaxLength="10" Width="150" />
            <asp:RequiredFieldValidator ControlToValidate="txtEnd" CssClass="validation-required validation-text" ValidationGroup="valSave" runat="server" ErrorMessage="" Text="" Display="Dynamic" SetFocusOnError="true" ID="RequiredFieldValidator10" /> 
        </div>
    </div>
    <div class="form-group">
