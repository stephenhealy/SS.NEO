...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="layout layout-stack-sm layout-main-left">
        ...
        <div class="col-sm-5 col-md-4 layout-sidebar">
            <div class="portlet portlet-default">
                <div class="portlet-header">
                    <h4 class="portlet-title">Bocce Availability</h4>
                </div><!-- /.portlet-header -->
                <div class="portlet-body">
                    ...
                    <div class="form-group">
                        <asp:LinkButton ID="btnBocce" runat="server" CssClass="btn btn-secondary" Text="<em class='fa fa-check'></em> Save" OnClick="btnBocce_Click" OnClientClick="return DoValidation('valSave',this);" />
                    </div>
                </div>
