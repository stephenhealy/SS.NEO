...
namespace Presentation.CMS._Modals
{
    public partial class Browse : PageClass
    {
        ...
        private WebServiceClient.BrowserDirectory GetDirectoryInfo(string _path)
        {
        ...
        private void LoadDirectory(string _path, WebServiceClient.BrowserDirectory oDirInfo, TreeView _tree, TreeNode _parent, bool Directories)
        {
            if (oDirInfo == null)
            {
