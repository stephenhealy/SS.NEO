...
namespace Data
{
    ...
    {
        public List<AdminList> PhotoCategory(bool Trash)
        {
            List<AdminList> items = (from all in db.PhotoCategories
        ...
        public Data.PhotoCategory PhotoCategory(int AssetID)
        {
            return (from all in db.PhotoCategories where all.AssetID == AssetID select all).FirstOrDefault();
        }
    }
}
