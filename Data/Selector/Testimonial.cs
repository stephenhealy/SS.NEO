...
namespace Data
{
    ...
    {
        public List<AdminList> Testimonial(int Parent, bool Trash)
        {
            List<AdminList> items = (from all in db.Testimonials
        ...
        public Data.Testimonial Testimonial(int AssetID)
        {
            return (from all in db.Testimonials where all.AssetID == AssetID select all).FirstOrDefault();
        }
    }
}
