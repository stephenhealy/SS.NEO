...
namespace Data
{
    ...
    {
        public List<AdminList> Sport(bool Trash)
        {
            List<AdminList> items = (from all in db.Sports
        ...
        public Data.Sport Sport(int AssetID)
        {
            return (from all in db.Sports where all.AssetID == AssetID select all).FirstOrDefault();
        }
    }
}
