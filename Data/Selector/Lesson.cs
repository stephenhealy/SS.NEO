...
namespace Data
{
    ...
    {
        public List<AdminList> Lesson(int Parent, bool Trash)
        {
            List<AdminList> items = (from all in db.Lessons
        ...
        public Data.Lesson Lesson(int AssetID)
        {
            return (from all in db.Lessons where all.AssetID == AssetID select all).FirstOrDefault();
        }
    }
}
