...
namespace Data
{
    ...
    {
        public List<AdminList> News(bool Trash)
        {
            List<AdminList> items = (from all in db.News
        ...
        public Data.News News(int AssetID)
        {
            return (from all in db.News where all.AssetID == AssetID select all).FirstOrDefault();
        }
    }
}
