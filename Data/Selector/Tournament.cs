...
namespace Data
{
    ...
    {
        public List<AdminList> Tournament(int Parent, bool Trash)
        {
            List<AdminList> items = (from all in db.Tournaments
        ...
        public Data.Tournament Tournament(int AssetID)
        {
            return (from all in db.Tournaments where all.AssetID == AssetID select all).FirstOrDefault();
        }
    }
}
