...
namespace Data
{
    ...
    {
        public List<AdminList> Position(bool Trash)
        {
            List<AdminList> items = (from all in db.Positions
        ...
        public Data.Position Position(int AssetID)
        {
            return (from all in db.Positions where all.AssetID == AssetID select all).FirstOrDefault();
        }
    }
}
