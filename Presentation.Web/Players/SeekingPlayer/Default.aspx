<%@ Page Title="" Language="C#" MasterPageFile="~/_Masters/players.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Presentation.Web.Players.SeekingPlayer.Default" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="heading-block">
                <h3>Team Seeking a Player</h3>
            </div>
            <div class="form form-horizontal">
                <div class="form-group">
                    <label class="control-label col-md-2">Your Name:</label>
                    <div class="col-md-10">
                        <div class="form-control-static"><asp:Literal ID="lblContact" runat="server" /></div>
                    </div> <!-- /.col -->
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label col-md-2">Your Team Name: <span>*</span></label>
                    <div class="col-md-10">
                        <asp:TextBox ID="txtTeam" runat="server" CssClass="form-control" MaxLength="50" />
                        <asp:RequiredFieldValidator ControlToValidate="txtTeam" CssClass="validation-required validation-text" ValidationGroup="valSave" runat="server" ErrorMessage="" Text="" Display="Dynamic" SetFocusOnError="true" ID="RequiredFieldValidator1" /> 
                    </div> <!-- /.col -->
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="checkbox">
                            <label>
                                ...
                                <asp:Label ID="lblFilled" runat="server" CssClass="text" Text="Check this when you have found a player." />
                            </label>
                        </div>
                    </div> <!-- /.col -->
                </div>
                <asp:Panel ID="panFilled" runat="server" CssClass="form-group">
                    <label class="control-label col-md-2"></label>
                    <div class="col-md-10">
                        <div class="form-control-static text-danger"><i class="fa fa-share fa-2x fa-rotate-270"></i> When you find a player, remember to come back and check this flag so everyone else knows.</div>
                    </div> <!-- /.col -->
                </asp:Panel>
                <div class="form-group">
                    <div class="col-md-10 col-md-push-2">
                        ...
                        <a href="<%= master.RelativePath %>/Players/SeekingPlayers" class="btn btn-default">Back</a>
                    </div> <!-- /.col -->
                </div>
            </div>
        </div>
