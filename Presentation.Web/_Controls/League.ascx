...
<ul id="myTab2" class="nav nav-pills">
    <li class="<%= CurrentMax > 0 || UpcomingMax == 0 ? "active" : "" %>">
        <a href="#current" data-toggle="tab">Current League Schedule & Standings <asp:Label ID="lblCurrent" runat="server" CssClass="badge badge-primary" /></a>
    </li>
    <li class="<%= CurrentMax == 0 && UpcomingMax > 0 ? "active" : "" %>">
        <a href="#upcoming" data-toggle="tab">Register for Upcoming Leagues <asp:Label ID="lblUpcoming" runat="server" CssClass="badge badge-primary" /></a>
    </li>
</ul>
<div id="myTab2Content" class="tab-content">
    <div class="tab-pane fade<%= CurrentMax > 0 || UpcomingMax == 0 ? " active in" : "" %>" id="current">
        <br class="xs-30">
    ...
    <div class="tab-pane fade<%= CurrentMax == 0 && UpcomingMax > 0 ? " active in" : "" %>" id="upcoming">
        <br class="xs-30">
        <div class="heading-block">
